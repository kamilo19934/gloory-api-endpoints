...
export const AVAILABLE_ENDPOINTS: EndpointDefinition[] = [
  ...
  // Appointments
  {
    ...
    arguments: [
      ...
      },
      {
        name: 'tiempo_cita',
        type: 'number',
        description: 'Duración de la cita en minutos. Si no se proporciona, se usa el intervalo del profesional',
        required: false,
        example: 30,
      },
      {
  ...
  },
  {
    ...
    description: 'Obtiene todas las citas futuras y activas (no anuladas) de un paciente por RUT. Las citas se ordenan por fecha y hora, mostrando la más próxima primero. Funciona con Dentalink y MediLink.',
    method: 'POST',
    ...
    arguments: [
      {
        name: 'rut',
        type: 'string',
        description: 'RUT del paciente (formato: 12345678-9 o 12345678). El sistema formateará automáticamente el RUT.',
        required: true,
        example: '12345678-9',
      },
    ],
